...
import NotLoggedThemeSwitcher from "./notLoggedThemeSwitcher";
...
export default function NavBar() {
  ...
  return (
    <nav className="border-gray-200 bg-slate-800 dark:bg-slate-950">
      <div className="mx-8 flex flex-wrap items-center justify-between p-4">
        <a href="/" className="flex items-center">
          <img
            src="https://companieslogo.com/img/orig/SU.PA-386facc5.png?t=1648148280"
            className="mr-3 h-8"
            alt="Flowbite Logo"
          />
          <span className="self-center whitespace-nowrap text-2xl font-semibold text-schneider-green">
            Schneider Connect
          </span>
        </a>
        ...
        <button
          ...
          type="button"
          className="ml-3 inline-flex items-center rounded-lg p-2 text-sm text-gray-400 transition-colors hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-600 md:hidden"
