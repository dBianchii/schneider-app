...
export function CreatePostModal({ setIsModalOpen, setPosts }) {
  ...
  return (
    <main className="fixed top-0 flex h-screen w-screen items-center justify-center bg-black/20 transition-colors">
      <div className="flex h-[36rem] w-[28rem] flex-col rounded-md border bg-gray-50 p-6 dark:bg-slate-950">
        <div className="flex items-center justify-between">
          <p className="text-2xl font-semibold dark:text-white">Criar post</p>
          <div
