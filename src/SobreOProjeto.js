    ...
    <>
      <div className="mx-52 flex flex-col items-center space-y-8">
        ...
        <p className="text-center text-lg text-gray-600">
          ...
          nisl eget aliquam ultricies, nunc nisl ultricies arcu, quis ultricies
          nisl nisl vitae nisl. sed euismod, nisl eget aliquam ultricies, nunc
          nisl ultricies arcu, quis ultricies nisl nisl vitae nisl. sed euismod,
          nisl eget aliquam ultricies, nunc nisl ultricies arcu, quis ultricies
          nisl nisl vitae nisl. sed euismod, nisl eget aliquam ultricies, nunc
          nisl ultricies arcu, quis ultricies nisl nisl vitae nisl. sed euismod,
          nisl eget aliquam
      ...
      <div className="space-y-8 bg-gray-200 px-32 py-8">
        ...
        <ul>
          <li className="text-lg text-gray-600">
            Projeto inicializado usando Create-React-App
          </li>
          <li className="text-lg text-gray-600">
            Conceitos de CSS aplicados utilizando TailwindCSS - uma alternativa
            ao bootstrap
          </li>
