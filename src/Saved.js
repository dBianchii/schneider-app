...
export default function SavedPage() {
  ...
  const posts = api.posts.getSavedPosts(params.userId);

  return (
    <section className="flex flex-col gap-3 dark:text-white">
      <p className="my-8 text-center text-3xl font-medium">Posts Salvos</p>
