		...
		<div class="max-w-sm rounded-lg border border-gray-200 bg-white shadow">
			...
			<div class="p-5">
				...
				<div className="mt-4 flex flex-row align-middle">
					{user && post.likes.includes(user.id) ? <AiFillHeart className="h-8 w-8 text-red-500 transition-colors hover:text-red-500/80" /> : <AiOutlineHeart className="h-8 w-8 transition-colors hover:text-red-500/80" />}
