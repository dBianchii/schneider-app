const users = [
  {
    ...
    followers: ["7e233ca7-f1fc-45a3-8a6f-e8977dd53910"],
    posts: [
      {
  ...
  },
  {
    ...
    followers: ["7e233ca7-f1fc-45a3-8a6f-e8977dd53910"],
    image:
      "https://gravatar.com/avatar/79fcbaf7e0a312decb04e94ce3e2ac94?s=400&d=robohash&r=x",
    posts: [
      {
...
const comments = [
  {
    ...
    content:
      "Ai meu Deus, eu adorei a ideia! A minha filha iria adorar fazer os próprios brinquedos.",
...
const posts = [
  {
    ...
    likes: ["355014e7-a3de-443b-b56c-5148077b1040"],
    comments: [],
    author: {
      id: "7e233ca7-f1fc-45a3-8a6f-e8977dd53910",
      name: "João Rodriguez",
  ...
  },
  {
    ...
    description:
      "Como ajudei uma instituição para crianças com produtos recicláveis.",
    ...
    comments: ["ec76f464-5f17-44b7-96e6-fb49ec7694f8"],
    author: {
      id: "3422afd7-4108-426e-8cee-6d165545dc2e",
      name: "Suellen Nakamoto",
      email: "suellenNakamoto@schneider.com",
      followers: ["7e233ca7-f1fc-45a3-8a6f-e8977dd53910"],
      image:
        "https://lh3.googleusercontent.com/a/AGNmyxYwLT_qbHap7Qn_IHQTBkdXK_rMPrC-BVp2UJJa=s96-c",
      posts: [
        {
          postId: "3d11110f-e0b1-47ac-a872-7b974f826ec6",
        },
  ...
  },
  {
    ...
    authorId: "12ef6180-7200-4087-8e8f-45268828eea2",
    description:
      "Olá! Eu vim contar como eu faço aqui em casa para reutilizar algumas garrafas pet.",
  ...
  },
  {
    ...
    likes: ["7e233ca7-f1fc-45a3-8a6f-e8977dd53910"],
    comments: [],
    author: {
      id: "355014e7-a3de-443b-b56c-5148077b1040",
      name: "Pedro Roçini",
  ...
  },
  {
    ...
    likes: ["7e233ca7-f1fc-45a3-8a6f-e8977dd53910"],
    comments: ["b6c2d51e-b755-4b83-b44c-6a6aaf0e4c92"],
    author: {
      id: "355014e7-a3de-443b-b56c-5148077b1040",
      name: "Pedro Roçini",
      email: "pedroRocini@schneider.com",
  ...
  },
  {
    ...
    authorId: "12ef6180-7200-4087-8e8f-45268828eea2",
    description:
      "Plástico é um mal que precisamos não só sabermos sobre, é necessário compreensão e mudança de hábitos. \n\n",
    ...
    likes: ["12ef6180-7200-4087-8e8f-45268828eea2"],
    comments: [],
    author: {
      id: "12ef6180-7200-4087-8e8f-45268828eea2",
      image:
  ...
  },
  {
    ...
    authorId: "3422afd7-4108-426e-8cee-6d165545dc2e",
    description:
      "Conhecendo a sua importância para o País e para a sustentabilidade!",
